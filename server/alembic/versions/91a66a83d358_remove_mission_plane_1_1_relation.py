...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Enum(
                ...
                "rainy",
                "snow",
                name="weathercondititions_flight",
            ),
            nullable=True,
        ),
    ...
    op.drop_constraint(
        "plane_mission_association_mission_id_fkey",
        "plane_mission_association",
        type_="foreignkey",
    )
    op.create_foreign_key(
        None, "plane_mission_association", "flight", ["flight_id"], ["flight_id"]
    )
...
def downgrade():
    ...
    op.add_column(
        "mission_details",
        sa.Column("observer", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
    op.add_column(
        "mission_details",
        sa.Column("pilot", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
