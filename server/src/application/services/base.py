...
from common.exceptions.db import DBException, NotFoundException
from domain import DomainEntity
from infrastructure.db.orm import Base
from sqlalchemy.orm import Session

Schema = TypeVar("Schema", bound=DomainEntity)
...
class CRUDBase(Generic[Model]):
    ...
    def patch(self, session: Session, id: int, filters: dict, data: DomainEntity) -> Model:
